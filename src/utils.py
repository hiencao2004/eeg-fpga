...
def set_cnn_model_parameters():
    ...
    parser.add_argument('--dataset', type=str, default='mit') # is pku before 2022.1.14
    ...
    parser.add_argument('--time_window_size',type=int, default=4,help='time window_size')# default=2,help='time window_size')
    parser.add_argument('--frequency',type=int, default=64, help='data frequency ')
